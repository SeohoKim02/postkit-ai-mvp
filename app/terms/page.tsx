...
const sections = [
  ...
  {
    title: "AI 생성 결과의 특성",
    body: "자동 생성된 결과는 오류, 중복 표현, 권리 문제, 플랫폼 정책 위반 가능성이 있을 수 있습니다. 독점적 저작권이나 상업적 안전성이 항상 보장되는 것은 아닙니다."
  },
  {
    title: "광고·협찬 표시 책임",
  ...
  {
    title: "신고와 삭제",
    body: "권리 침해 신고 및 삭제 요청은 베타 기간 동안 이 브라우저에 기록을 남기는 방식으로 제공됩니다. 정식 운영 전 접수, 검토, 임시조치, 이의제기, 기록 보존 절차를 갖춰 다시 안내합니다."
  },
  {
    title: "서비스 제한",
