...
const sections = [
  ...
  {
    title: "보유 기간",
    body: "mock 단계에서는 localStorage에 저장되며, 사용자가 삭제하거나 설정한 보관 기간에 따라 정리합니다. 실제 운영 시 데이터 유형별 보유 기간과 파기 기준을 서버 정책으로 확정해야 합니다."
  },
  {
    title: "개인정보 처리 위탁",
  ...
  {
    title: "정보주체의 권리",
    body: "사용자는 보호센터에서 mock 데이터 내보내기, 삭제, 개인 맞춤 학습 중지, 신고 요청을 할 수 있습니다. 실제 운영 전 열람·정정·삭제·처리정지 요청 절차를 확정해야 합니다."
  },
  {
    title: "안전성 확보조치",
  ...
  {
    title: "처리방침 변경 내역",
    body: "v0.1 mock 초안: 개인정보 보호센터, 삭제·내보내기, 감사 기록, 권리 침해 신고 UI 기준으로 작성되었습니다."
  }
];
