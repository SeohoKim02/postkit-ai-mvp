...
> **[후속 조치 완료 — 2026-07-07, 커밋 d99ee01 + 후속 커밋]**
> 이 보고서가 지적한 무료 공개 베타 출시 조건은 `fable-release-audit` 브랜치에서 수정 완료됐다.
> 처리 내역·재검증 결과·갱신 점수(58→72)는 [FABLE_RELEASE_COMPLETION.md](./FABLE_RELEASE_COMPLETION.md) 참고.
> 요약: H-01(Free 기본 플랜+워터마크 전원 적용), H-02(IP rate limit, 429 실측), H-03(placeholder 제거·기본 템플릿 실렌더),
> M-01~M-04·M-06·M-07, L-01~L-05 해결. 자동 테스트 23건 신설, lint 경고 0. 아래 본문은 검수 시점 기록 원본이다.
> **잔여 출시 조건: PNG/WebM 실물 수동 브라우저 QA 1회** (아래 "출시 전 필수 수정" 5번 항목).
